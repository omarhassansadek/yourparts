...
class quantityPickerDelegate : NSObject ,UIPickerViewDelegate, UIPickerViewDataSource {
    
//    var campaingsArr = [Campaign]()
//    var photosArray = [Photo]()
//    var profilesArray = [Photographer]()
   
    var countArr = ["1" , "2" , "3" , "4" , "5" , "6"]

    var targetController : cartViewController?
    var row: Int?
    var type: String?
